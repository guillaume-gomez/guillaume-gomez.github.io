const translations = {
    "fr": {
        ...
        about_me_content: "Codeur depuis environ 10 ans ; j'ai écrit mes premières lignes de code en C, pour ensuite découvrir beaucoup d'autres langages que ce soit à travers mon cursus universitaire ou professionel. Passionné par l'aspect créatif que peut être l'informatique, j'essaye à travers des projets personnels d'entrevoir d'autres technologies ainsi que d'autres algorithmes. Quand je ne programme pas, je fais du sport. Et il m'arrive très souvent de faire l'une des deux activitées en musique. Je laisse donc en lien mon compte senscritique pour parler musique ou autres ; en plus des classiques github et linkedin :)",
        ...
        personal_project_langton_content: "Implémentantion de l'algorithme de la fourmi de langton dans le but d'apprendre Phaser Js, et de se mettre à jour sur le javascript(ES6).",
